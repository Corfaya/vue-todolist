...
- Creare app
    - Dati:
        - Array di oggetti con due proprietà da stampare come lista su HTML (proprietà done === true ? testo sbarrato)
    - Metodi:
        - Al click del button x, cancello il list item dalla lista
        - Funzione al click per inserire il nuovo oggetto nell'array della todo list
- Montare su #app